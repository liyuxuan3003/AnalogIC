...
netlist2=netlist
netlist2.set_component_value("RD1","15k")
netlist2.set_component_value("RD2","5k")
...
plt.plot(xVinRSS,xVoutRSS,c='gray',ls='dotted',label="$V_{out,CM}, R_{D1}=R_{D2}$")
...
plt.plot(xVinRSS,xZero,c='gray',ls='dotted',label="$V_{out,DM}, R_{D1}=R_{D2}$")
plt.plot(xVinRD,xVoutDMRD,c='k',label="$V_{out,DM}$")

plt.figure(idAVCDRD)
plt.plot(xVinRSS,xZero,c='gray',ls='dotted',label="$A_{CM-DM}, R_{D1}=R_{D2}$")
plt.plot(xVinRD,xAVCDRD,c='k',label="$A_{CM-DM}$")

plt.figure(idAVCMRD)
plt.plot(xVinRSS,xAVCMRSS,c='gray',ls='dotted',label="$A_{CM}, R_{D1}=R_{D2}$")
